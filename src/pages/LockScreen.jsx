...
export default function LockScreen({ onUnlock }) {
  ...
  const [hint, setHint] = useState('Hecho con cariño para los próximos 4 meses 💛')
  ...
  const tryUnlock = () => {
    if (pass.trim().toLowerCase() === SECRET) {
      ...
      setHint('Nope... probá otra vez, te amo ❤️')
      setPass('')
      setTimeout(() => setHint('Hecho con cariño para los próximos 4 meses 💛'), 2000)
    }
  }
  ...
  return (
    <div className="login-scene" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="login-card" style={{ fontFamily: 'Playfair Display, serif', letterSpacing: 1, zIndex: 2, position: 'relative' }}>
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontWeight: 700, color: '#E6A9B5', fontSize: '2rem', marginBottom: 8 }}>Hola hermosa... tengo algo para vos</h1>
        <p style={{ color: '#b56d87', fontSize: '1.1rem', marginBottom: 18 }}>Ingresá la contraseña para descubrirlo ✨</p>
